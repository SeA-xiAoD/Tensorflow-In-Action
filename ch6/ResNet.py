...
def subsample(inputs, factor, scope=None):
    '''A function using to reduce the size of inputs.'''
    if factor == 1:
        return inputs
    else:
...
def resnet_v2_50(inputs, num_classes=None, global_pool=True, reuse=None,
                scope='resnet_v2_50'):
    '''A function to generate deep ResNet-50.'''
...
def resnet_v2_101(inputs, num_classes=None, global_pool=True, reuse=None,
                scope='resnet_v2_101'):
    '''A function to generate deep ResNet-101.'''
...
def resnet_v2_152(inputs, num_classes=None, global_pool=True, reuse=None,
                scope='resnet_v2_152'):
    '''A function to generate deep ResNet-152.'''
...
def resnet_v2_200(inputs, num_classes=None, global_pool=True, reuse=None,
                scope='resnet_v2_200'):
    '''A function to generate deep ResNet-200.'''
...
if __name__=='__main__':
    ...
    with slim.arg_scope(resnet_arg_scope(is_training=False)):
        logits, end_points = resnet_v2_200add(inputs, 1000)
